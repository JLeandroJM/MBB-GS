...
def cargar_clip(carpeta_clip, device, max_frames=None, frames_en_cpu=False):
    ...
    if frames_en_cpu:
        ...
        # Mucho menos VRAM y menos RAM que float32.
        try:
    ...
    # Modo antiguo: todos los frames a GPU como float32.
