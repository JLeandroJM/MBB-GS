...
def main():
    ...
    agregar_arg(cmd, "--sigma-inicial-bins", cfg.get("sigma_inicial_bins"))
    agregar_arg(cmd, "--finetune-epochs", cfg.get("finetune_epochs"))
    agregar_arg(cmd, "--finetune-lr-scale", cfg.get("finetune_lr_scale"))
