...
Uso:
    python scripts/viz_elipses_velocidades.py --checkpoint outputs/EXP/checkpoints/checkpoint_final.pt --frame 375 --fondo_dir outputs/EXP/frames_renderizados

Mejora:
    Puedes pasar IDs especificos:
    python scripts/viz_elipses_velocidades.py --checkpoint ... --frame 375 --ids 123 456 789

    O leer ids desde un CSV generado por viz_gaussian_stats.py:
    python scripts/viz_elipses_velocidades.py --checkpoint ... --frame 375 --ids_csv outputs/EXP/viz_stats/top_movimiento.csv --n_max 100
"""
